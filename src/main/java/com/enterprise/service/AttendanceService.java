...
public interface AttendanceService {
	...
	List<CurrentClassResponse> getFacultyClassesForAttendance(String facultyId, LocalDate date);

	List<FacultySessions> getFacultySessions(String facultyId, LocalDate fromDate, LocalDate toDate);

	AttendanceOverviewResponse getStudentAttendanceSummary(String subjectId, String sectionId);
